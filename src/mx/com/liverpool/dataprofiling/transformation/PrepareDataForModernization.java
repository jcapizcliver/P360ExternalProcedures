...
public class PrepareDataForModernization {
	...
	public static void main(String[] args) {
		...
		java.nio.file.Path targetPath = java.nio.file.Paths.get("C:", "opt", "LVP", "desorden", "BQ", "tmp", "Attributes", "DatosModernización.csv");
					...
					if( (prevTemplate != null && !prevTemplate.equals(pieces[0])) || (prevProduct != null && !prevProduct.equals(pieces[1])) ) {
						...
						if(genericSKUDataValue != null) {
							...
							for(String att : ATTRIBUTES) {
								...
								genericSKUDataValue.put(att, attributeValue == null ? "" : workshop.serializeChunk(attributeValue, "\"", ";", "\\"));
							}
						}
