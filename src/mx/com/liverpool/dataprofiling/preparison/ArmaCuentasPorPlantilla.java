...
public class ArmaCuentasPorPlantilla {
	...
	public static void main(String[] args) {
		...
		try(java.io.BufferedReader br = 
				new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(java.nio.file.Paths.get("C:", "opt", "LVP", "desorden", "BQ", "tmp", "Attributes", "AtributosPlantillas.csv").toFile()), java.nio.charset.StandardCharsets.UTF_8))){
			String line = null;
			String[] pieces = null;
			br.readLine();
			String key = null;
		...
		try(java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(java.nio.file.Paths.get("C:", "opt", "LVP", "desorden", "BQ", "prof", "CompletitudDeAtributosPorPlantilla.csv").toFile()), java.nio.charset.StandardCharsets.UTF_8))){
