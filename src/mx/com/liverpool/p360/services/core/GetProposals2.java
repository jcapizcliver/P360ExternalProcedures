...
public class GetProposals2 implements Closeable {

	private final DBAccessDataStub dastub = new DBAccessDataStub( new ELog() {
		
		@Override
		public void logE(Exception e) {
			GetProposals2.this.logE(e);
		}
		
		@Override
		public void log(String message) {
			GetProposals2.this.log(message);
		}
	} );
  ...
  public GetProposals2(String baseUrl, String encoded, long myId) {
...
//		}
	...
	private static final java.util.logging.Logger LOGGER =
	        java.util.logging.Logger.getLogger(GetProposals2.class.getName());
