...
public class SearchProductSKUs {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	SearchProductSKUs an = new SearchProductSKUs();
        ...
        an.log("Missings:");
        try(
        	java.io.PrintWriter pw  = new java.io.PrintWriter( new java.io.OutputStreamWriter(new java.io.FileOutputStream(java.nio.file.Paths.get("SKUFound").toFile())) );
        	java.io.PrintWriter pwN = new java.io.PrintWriter( new java.io.OutputStreamWriter(new java.io.FileOutputStream(java.nio.file.Paths.get("SKUNotFound").toFile())) ) 
        ){
        ...
        an.log("*** Result");
        an.log("With no SKU: " + an.sinSKU);
        System.out.println("With no SKU: " + an.sinSKU);
    ...
    private void loadIDs() {
    	try(java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(java.nio.file.Paths.get("SKUsToSearch").toFile())))){
    		String line = null;
    		IDs = new String[1024];
