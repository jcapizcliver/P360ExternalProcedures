...
public class LoadProductDataSecondOpinionFirstDateApprove {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	LoadProductDataSecondOpinionFirstDateApprove an = new LoadProductDataSecondOpinionFirstDateApprove();
...
//    }
    ...
    private final org.json.JSONArray columns = new org.json.JSONArray()
	    		.put(new org.json.JSONObject().put("identifier", "Product2G.FirstDateApproved"))
	    		.put(new org.json.JSONObject().put("identifier", "Product2G.LastDateApproved"))
			;
    ...
    private void processProduct(Product product) {
    	if(!product.getParentId().startsWith("EU")) {
    	...
    	if(values != null) {
    		...
    		String firstDateApproveStr = firstDateApprove == null ? "" : firstDateApprove.getText() == null ? "" : firstDateApprove.getText() ;
    		String lastDateApproveStr = lastDateApprove == null ? "" : lastDateApprove.getText() == null ? "" : lastDateApprove.getText() ;
    		if(firstDateApproveStr != null && !"".equals(firstDateApproveStr))
    			firstDateApproveStr = convertirFecha(firstDateApproveStr); 
    		if(lastDateApproveStr != null && !"".equals(lastDateApproveStr))
    			lastDateApproveStr = convertirFecha(firstDateApproveStr); 
    		vals.put(firstDateApproveStr);
    		vals.put(lastDateApproveStr);
    ...
    private void processChild(Product child) {
		...
		String lastDateApproveStr = lastDateApprove == null ? "" : lastDateApprove.getId() != null ? lastDateApprove.getId() : lastDateApprove.getText() == null ? "" : lastDateApprove.getText() ;
		if(firstDateApproveStr != null && !"".equals(firstDateApproveStr))
			firstDateApproveStr = convertirFecha(firstDateApproveStr); 
		if(lastDateApproveStr != null && !"".equals(lastDateApproveStr))
			lastDateApproveStr = convertirFecha(firstDateApproveStr); 
