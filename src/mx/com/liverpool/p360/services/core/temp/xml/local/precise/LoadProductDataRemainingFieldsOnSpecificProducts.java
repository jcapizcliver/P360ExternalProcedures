...
public class LoadProductDataRemainingFieldsOnSpecificProducts {
	...
	public LoadProductDataRemainingFieldsOnSpecificProducts() {
		qp.put("includeObjectsInProtocol", "false");
		collectActiveCharacteristics();
	}
    ...
    public static void main(String[] args) throws Exception {
    	...
    	LoadProductDataRemainingFieldsOnSpecificProducts an = new LoadProductDataRemainingFieldsOnSpecificProducts();
