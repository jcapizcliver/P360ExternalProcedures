...
public class LKPs {
	...
	public static void main(String[] args) {
		...
		try(java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream("C:\\opt\\LVP\\tmp\\att confi - Att nuevos.tsv")))){
			String line = null;
			String[] pieces = null;
			String sep = "\t";
			String delim = "\"";
			...
			while((line = br.readLine()) != null) {
				...
				rows.put(new org.json.JSONObject().put("object", new org.json.JSONObject().put("id", "'" + pieces[2] +"'" )).put("values", new org.json.JSONArray().put(pieces[3])));
				if(rows.length() == 50) {
