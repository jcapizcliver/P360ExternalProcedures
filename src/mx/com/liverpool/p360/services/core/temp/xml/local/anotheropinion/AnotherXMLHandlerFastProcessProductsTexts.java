...
public class AnotherXMLHandlerFastProcessProductsTexts {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	AnotherXMLHandlerFastProcessProductsTexts an = new AnotherXMLHandlerFastProcessProductsTexts();
...
//    		missingParents.add(product.getParentId());
    	...
    	if(values != null) {
    		...
    		String productNameStr = productName == null ? nameStr : productName.getText() ;
