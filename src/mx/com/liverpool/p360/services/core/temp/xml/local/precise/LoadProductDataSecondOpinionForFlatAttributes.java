...
public class LoadProductDataSecondOpinionForFlatAttributes {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	LoadProductDataSecondOpinionForFlatAttributes an = new LoadProductDataSecondOpinionForFlatAttributes();
    	if (args.length == 0) {
        ...
        java.nio.file.Path path = java.nio.file.Paths.get(args.length == 1 ? "ProductTemplateAttributesPerFile.csv" : args[1]);
        try{
        	an.pw = new java.io.PrintWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(path.toFile())));
        	an.pw.println( an.rw.getRw().serializeChunk( header ) );
    ...
    private final java.util.Map<String, java.util.Map<String, java.util.Set<String>>> ladata = new java.util.HashMap<>();
    private final java.util.List<String> ids = new java.util.ArrayList<>();
    private final java.util.Map<String, String> losPas = new java.util.HashMap<>();
    
    private java.io.PrintWriter pw = null;
    
    private void processProduct(Product product, String file) {
...
//    	losPas.put(product.getId(), product.getParentId());
    	if(values != null) {
//    		java.util.Map<String, java.util.Set<String>> subSet = ladata.get(product.getId());
//    		if(subSet == null) {
//    			subSet = new java.util.HashMap<>();
//    			ladata.put(product.getId(), subSet);
//    		}
//        	java.util.Set<String> attributeIDs = subSet.get(file);
//        	if(attributeIDs == null) {
//        		attributeIDs = new java.util.TreeSet<>();
//        		subSet.put(file, attributeIDs);
//        	}
    		
    		for(Value value : values) {
    			pw.println( rw.getRw().serializeChunk( new Object[] { product.getId(), product.getParentId(), file, value.getAttributeId() } ) );
    		}
    	}else {
