...
public class AnotherXMLHandler {
	...
	private final boolean sendLkpValues = true;
    ...
    private static String[] parseString(String linea) {
    	return linea.split(",");
    }
    
    private static String obtenerNombre(String[] arr) {
    	return arr[1];
    }
    ...
    public static void main(String[] args) throws Exception {
    	...
    	AnotherXMLHandler an = new AnotherXMLHandler();
        if (args.length == 0) {
