...
public class AnotherXMLHandlerLinkVariantsToProductsFromSKU {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	AnotherXMLHandlerLinkVariantsToProductsFromSKU an = new AnotherXMLHandlerLinkVariantsToProductsFromSKU();
        if (args.length == 0) {
