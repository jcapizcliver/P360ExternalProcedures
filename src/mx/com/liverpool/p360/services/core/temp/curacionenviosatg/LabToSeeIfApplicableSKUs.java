...
public class LabToSeeIfApplicableSKUs {
...
//		try(java.io.BufferedReader br = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(java.nio.file.Paths.get("C:", "opt", "LVP", "desorden", "PROD", "LabToCheckIfSendableSKUs.yxy").toFile())))){
			...
			System.out.println("Leímos: " + n + " skus genéricos/individuales. Fueron: " + idsProductos.size() + " productos.");
			...
			String pid = null;
			String[] pidData = null;
			try(java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(java.nio.file.Paths.get("C:", "opt", "LVP", "desorden", "PROD", "Data for those who are not in there From Lista de SKUs GenInd.csv").toFile())))){
	...
	private static String[] veredicto(String[] data) {
		...
		if( "".equals(data[5]) && "".equals(data[6]) ) {
