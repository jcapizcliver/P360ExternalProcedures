...
public class LoadProductDataSecondOpinionSinEstados {
    ...
    public static int processContent(String content) throws Exception {
    	...
    	LoadProductDataSecondOpinionSinEstados an = new LoadProductDataSecondOpinionSinEstados();
    ...
    private void processProduct(Product product) {
    	...
    	if(children != null && !children.isEmpty()) {
    		for(Product child : children) {
    			if("S94381333".equals(product.getId()) || "S94022875".equals(product.getId())) {
