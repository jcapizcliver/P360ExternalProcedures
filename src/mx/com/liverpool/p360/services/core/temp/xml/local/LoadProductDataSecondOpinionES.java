...
public class LoadProductDataSecondOpinionES {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	LoadProductDataSecondOpinionES an = new LoadProductDataSecondOpinionES();
...
//    	}
    	...
    	if(values != null) {
    		...
    		bundle = !"".equals(calculatedWFAtt) && !"".equals(statusSKU) ? elese.computeStatus(calculatedWFAtt, statusSKU, fotoTomadaLiverpool, product.getId()) : new String[] { null, null, null };
    		...
    		products.put(new org.json.JSONObject().put("internalStatus", getStatusLabel(currentStatus)).put("previousStatus", getStatusLabel(bundle[1])).put("externalStatus", externalStatusLabels.get( externalStatus )).put("proposalId", product.getId()).put("entityType", "Generic"));
