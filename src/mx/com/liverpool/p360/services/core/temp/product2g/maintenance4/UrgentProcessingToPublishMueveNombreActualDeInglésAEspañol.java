...
public class UrgentProcessingToPublishMueveNombreActualDeInglésAEspañol {
	...
	public static void main(String[] args) {
		...
		qp.put("fields", "Product2GLang.ProductName(en)");
		
		java.util.Map<String, String> qp0 = new java.util.HashMap<>();
		qp0.put("includeObjectsInProtocol", "false");
		RequestHandler rh = new RequestHandler( new org.json.JSONArray().put(new org.json.JSONObject().put("identifier", "Product2GLang.ProductName(es)")), 2000, request -> rw.writeData("list", "Product2G", null, qp, request, System.out::println) );
