...
public class LosDeMarketplaceParaVerLosQueNoDebenSerSusEseCaUs {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	LosDeMarketplaceParaVerLosQueNoDebenSerSusEseCaUs an = new LosDeMarketplaceParaVerLosQueNoDebenSerSusEseCaUs();
        ...
        try(java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(java.nio.file.Paths.get("Summary_From_MkpSKUs.csv").toFile())))){
        	an.tainted.forEach((k,v)->{
        		pw.println( an.rw.getRw().serializeChunk(new String[] { k, an.rw.getRw().serializeChunk( v.toArray(new String[] {}), "\"", ";", "\\" ) }) );
        	});
