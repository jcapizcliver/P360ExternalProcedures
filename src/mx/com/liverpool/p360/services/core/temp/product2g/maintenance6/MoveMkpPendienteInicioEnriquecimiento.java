...
public class MoveMkpPendienteInicioEnriquecimiento {
	...
	public static void main(String[] args) {
		if(args.length == 0) {
			args = new String[] { "C:\\opt\\LVP\\desorden\\PROD\\sqlrunner_PIM_MASTER_20260601_122039.csv" };
		}
		...
		for(String pid : pids) {
			rh.addRow(new org.json.JSONObject().put("object", new org.json.JSONObject().put("id", "'" + pid + "'@1")).put("values", new org.json.JSONArray().put("Carga de Imagen")));
		}
		rh.sendData();
	}
